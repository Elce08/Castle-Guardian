...
[CreateAssetMenu(fileName = "New Item Data - Archor_LongBow1", menuName = "Scriptable Object/Item Data - Archor_LongBow1", order = 5)]
public class ItemData_Archor_LongBow1 : ItemData
{
    [Header("장궁1 데이터")]
    ItemData data;
