...
[CreateAssetMenu(fileName = "New Item Data - Archor_LongBow2", menuName = "Scriptable Object/Item Data - Archor_LongBow2", order = 6)]
public class ItemData_Archor_LongBow2 : ItemData
{
    [Header("장궁2 데이터")]
    ItemData data;

    public override WeaponType equipPart => WeaponType.Archor_LongBow;
    ...
    public override void ItemStatus()
    {
        ...
        beforeDef = (upgrade + 1) * 10;                 // 아이템의 강화 전 Def 수치
        ...
        afterDef = (upgrade + 2) * 10;                  // 아이템의 강화 후 Def 수치
