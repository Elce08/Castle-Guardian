...
[CreateAssetMenu(fileName = "New Item Data - Gunner1", menuName = "Scriptable Object/Item Data - Gunner1", order = 6)]
public class ItemData_Gunner1 : ItemData
{
    [Header("총1 데이터")]
    ItemData data;

    public override WeaponType equipPart => WeaponType.Gunner;
