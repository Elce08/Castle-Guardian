...
public class Stat_1 : MonoBehaviour
{
    ...
    private void Update()
    {
        status[0].text = $"Str {(gameManager.selectType1Str + Str[0] + Str[1] + Str[2]).ToString()}";
        status[1].text = $"Def {(gameManager.selectType1Def + Def[0] + Def[1] + Def[2]).ToString()}";
        status[2].text = $"HP {(gameManager.selectType1HP + HP[0] + HP[1] + HP[2]).ToString()}";
        status[3].text = $"MP {(gameManager.selectType1MP + MP[0] + MP[1] + MP[2]).ToString()}";
        status[4].text = $"Speed {(gameManager.selectType1Speed).ToString()}";
    }
    ...
    public void Status()
    {
        ...
        gameManager.player1Str = gameManager.selectType1Str + Str[0] + Str[1] + Str[2];
        gameManager.player1Def = gameManager.selectType1Def + Def[0] + Def[1] + Def[2];
        gameManager.player1HP = gameManager.selectType1HP + HP[0] + HP[1] + HP[2];
        gameManager.player1MP = gameManager.selectType1MP + MP[0] + MP[1] + MP[2];
    }
}
