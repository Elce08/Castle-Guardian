...
public class Stat_2 : MonoBehaviour
{
    ...
    private void Update()
    {
        status[0].text = $"Str {(gameManager.selectType2Str + Str[0] + Str[1] + Str[2]).ToString()}";
        status[1].text = $"Def {(gameManager.selectType2Def + Def[0] + Def[1] + Def[2]).ToString()}";
        status[2].text = $"HP {(gameManager.selectType2HP + HP[0] + HP[1] + HP[2]).ToString()}";
        status[3].text = $"MP {(gameManager.selectType2MP + MP[0] + MP[1] + MP[2]).ToString()}";
        status[4].text = $"Speed {(gameManager.selectType2Speed).ToString()}";
    }
    ...
    public void Status()
    {
        ...
        gameManager.player2Str = gameManager.selectType2Str + Str[0] + Str[1] + Str[2];
        gameManager.player2Def = gameManager.selectType2Def + Def[0] + Def[1] + Def[2];
        gameManager.player2HP = gameManager.selectType2HP + HP[0] + HP[1] + HP[2];
        gameManager.player2MP = gameManager.selectType2MP + MP[0] + MP[1] + MP[2];
    }
}
